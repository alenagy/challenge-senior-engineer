...
public class TodoListsControllerTests
{
    ...
    {
        context.TodoList.Add(new TodoList { Id = 1, UID = Guid.NewGuid(), LastUpdated = DateTime.Now, Name = "Task 1" });
        context.TodoList.Add(new TodoList { Id = 2, UID = Guid.NewGuid(), LastUpdated = DateTime.Now, Name = "Task 2" });
        context.SaveChanges();
    }
